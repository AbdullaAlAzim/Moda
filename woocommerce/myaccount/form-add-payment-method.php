        ...
        <div id="payment" class="woocommerce-Payment">
            ...
            <div class="form-row">
                ...
                <button type="submit" class="woocommerce-Button woocommerce-Button--alt button alt" id="place_order"
                        value="<?php esc_attr_e('Add payment method', 'moda'); ?>"><?php esc_html_e('Add payment method', 'moda'); ?></button>
...
<?php else : ?>
    <p class="woocommerce-notice woocommerce-notice--info woocommerce-info"><?php esc_html_e('New payment methods can only be added during checkout. Please contact us if you require assistance.', 'moda'); ?></p>
<?php endif; ?>
